...
このチュートリアルのデモ・プロジェクトのダウンロードはこちらから：[PIP](https://docs.juce.com/master/tutorials/PIPs/SynthDecibelLevelControlTutorial.zip)|[ZIP](https://docs.juce.com/master/tutorials/ZIPs/SynthDecibelLevelControlTutorial.zip).プロジェクトを解凍し、最初のヘッダーファイルをProjucerで開く。
