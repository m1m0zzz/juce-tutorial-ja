...
このセクションのデモ・プロジェクトのダウンロードはこちらから：[PIP](https://docs.juce.com/master/tutorials/PIPs/OSCSenderTutorial.zip)|[ZIP](https://docs.juce.com/master/tutorials/ZIPs/OSCSenderTutorial.zip).プロジェクトを解凍し、最初のヘッダーファイルをProjucerで開く。
...
このセクションのデモ・プロジェクトのダウンロードはこちらから：[PIP](https://docs.juce.com/master/tutorials/PIPs/OSCReceiverTutorial.zip)|[ZIP](https://docs.juce.com/master/tutorials/ZIPs/OSCReceiverTutorial.zip).プロジェクトを解凍し、最初のヘッダーファイルをProjucerで開く。
...
このセクションのデモ・プロジェクトのダウンロードはこちらから：[PIP](https://docs.juce.com/master/tutorials/PIPs/OSCMonitorTutorial.zip)|[ZIP](https://docs.juce.com/master/tutorials/ZIPs/OSCMonitorTutorial.zip).プロジェクトを解凍し、最初のヘッダーファイルをProjucerで開く。
