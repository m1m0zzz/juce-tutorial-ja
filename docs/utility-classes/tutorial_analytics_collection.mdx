...
このチュートリアルのデモ・プロジェクトのダウンロードはこちらから：[PIP](https://docs.juce.com/master/tutorials/PIPs/AnalyticsCollectionTutorial.zip)|[ZIP](https://docs.juce.com/master/tutorials/ZIPs/AnalyticsCollectionTutorial.zip).プロジェクトを解凍し、最初のヘッダーファイルをProjucerで開く。
