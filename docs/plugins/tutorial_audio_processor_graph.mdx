...
クラス： [オーディオプロセッサ](https://docs.juce.com/master/classAudioProcessor "Base class for audio processing classes or plugins."), [オーディオ・プロセッサー・プレーヤー](https://docs.juce.com/master/classAudioProcessorPlayer "An AudioIODeviceCallback object which streams audio through an AudioProcessor."), [オーディオ・プロセッサ・グラフ](https://docs.juce.com/master/classAudioProcessorGraph "A type of AudioProcessor which plays back a graph of other AudioProcessors."), [AudioProcessorGraph::AudioGraphIOProcessor](https://docs.juce.com/master/classAudioProcessorGraph_1_1AudioGraphIOProcessor "A special type of AudioProcessor that can live inside an AudioProcessorGraph in order to use the audi..."), [AudioProcessorGraph::Node](https://docs.juce.com/master/classAudioProcessorGraph_1_1Node "Represents one of the nodes, or processors, in an AudioProcessorGraph."), [オーディオデバイスマネージャー](https://docs.juce.com/master/classAudioDeviceManager "Manages the state of some audio and midi i/o devices.")

# Getting started

Download the demo project for this tutorial here: [ピップ](/tutorials/PIPs/AudioProcessorGraphTutorial.zip) | [ジップ](/tutorials/ZIPs/AudioProcessorGraphTutorial.zip). Unzip the project and open the first header file in the Projucer.
...
The following three processors will make use of the DSP module to facilitate implementation and if you want to learn more about DSP you can refer to [チュートリアルDSP入門](../tutorial_dsp_introduction/) for a more in-depth explanation.
