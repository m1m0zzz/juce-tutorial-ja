...
<CaptionImage src="/_images/tutorial_audio_processor_graph_screenshot1.png" caption="The channel strip plugin window" />
...
Next, in the `チュートリアルプロセッサー` constructor we set the default bus properties for the plugin and instantiate the main [オーディオ・プロセッサ・グラフ](https://docs.juce.com/master/classAudioProcessorGraph "A type of AudioProcessor which plays back a graph of other AudioProcessors.") as shown here:
