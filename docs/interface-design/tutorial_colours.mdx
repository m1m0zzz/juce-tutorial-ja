...
このチュートリアルのデモ・プロジェクトのダウンロードはこちらから：[PIP](https://docs.juce.com/master/tutorials/PIPs/ColoursTutorial.zip)|[ZIP](https://docs.juce.com/master/tutorials/ZIPs/ColoursTutorial.zip).プロジェクトを解凍し、最初のヘッダーファイルをProjucerで開く。
...
- [Label::backgroundWhenEditingColourId](https://docs.juce.com/master/classLabel.html#a41756012394513222e1323bb432fa701a6ccfd805ecc818013ea4bdde69d4258b "ラベル編集時の背景色。")ラベル編集時の背景色。
