...
チュートリアル・プロジェクトの完成版はこちらからダウンロードできる：[PIP](https://docs.juce.com/master/tutorials/PIPs/MainComponentTutorial.zip)|[ZIP](https://docs.juce.com/master/tutorials/ZIPs/MainComponentTutorial.zip)そして自分のものと比較する。
