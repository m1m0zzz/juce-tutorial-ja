...
このチュートリアルのデモ・プロジェクトのダウンロードはこちらから：[PIP](https://docs.juce.com/master/tutorials/PIPs/GraphicsTutorial.zip)|[ZIP](https://docs.juce.com/master/tutorials/ZIPs/GraphicsTutorial.zip)
